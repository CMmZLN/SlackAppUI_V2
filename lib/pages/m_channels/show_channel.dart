...
class _ShowChannelState extends State<ShowChannel> {
      ...
      setState(() {
        ...
        if (userCount == 0) {
          ...
          Navigator.pushAndRemoveUntil(
              context,
              MaterialPageRoute(
                  builder: (context) => const MyHomePage(title: "Slack APP")),
              (route) => false);
        } else {
          tGroupMessageDates =
          ...
          channelName =
              data["retrieveGroupMessage"]["s_channel"]["channel_name"];
          tGroupStarMsgids =
  ...
  Widget showMessages(
    ...
    return Scrollbar(
      child: mChannelIds.contains(channelData["id"])
          ? ListView.builder(
                          ...
                          itemBuilder: (context, index) => Column(
                            children: <Widget>[
                              if (tGroupMessageDates[index1]["created_date"]
                                      .toString() ==
                                  ymd.format(DateTime.parse(tGroupMessage[index]
                                              ["created_at"]
                                          .toString())
                                      .toLocal()))
                                // color changes for channel chat box
                                Container(
                ...
                children: [
                    ...
                    child: Row(
                      children: [
                        ...
                        TextButton.icon(
                          ...
                          icon: mChannelIds.contains(channelId)
                              ? const Icon(Icons.people, color: Colors.black)
                              : const Text(""),
                          label: mChannelIds.contains(channelId)
                  ...
                  Expanded(
                      ...
                      child: showMessages(
                          ...
                          tGroupStarMsgids,
                          channelData)),
                  !isLoading && mChannelIds.length != 0 && channelId != 0
...
class _SendGroupMessageInputState extends State<SendGroupMessageInput> {
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
        ...
        child: widget.mChannelIds.contains(widget.channelId)
            ? Padding(
                ...
                child: Row(
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () {
                        _btnActive == true
                            ? sendGroupMessage(sendText, widget.channelId)
                            : null;

                        if (_btnActive == true) {
                          keyForFlutterMention.currentState?.controller
                              ?.clear();
                          setState(() {
                            SchedulerBinding.instance.addPostFrameCallback((_) {
                              groupMessageDateScroller.animateTo(
                                groupMessageDateScroller
            ...
            : SizedBox(
                ...
                child: ElevatedButton(
                    onPressed: () async {
                      await channelJoin(widget.channelId);
